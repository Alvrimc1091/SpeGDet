...
log_file_path = "/home/pi/logs/split_logs/split_logs.log"
...
def main(): 
    logger = setup_logger()
    log_files = ["/home/pi/logs/boot_log/boot_log.log", "/home/pi/logs/rpisensor/rpisensor.log", "/home/pi/logs/log_rpiftpsensor/log_rpiftpsensor.log", "/home/pi/logs/split_logs/split_logs.log"]
