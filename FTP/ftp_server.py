...
# Set up logging
logging.basicConfig(filename='/home/pi/SpeGDet/FTP/ftp_server.log',  # Path to the log file
                    level=logging.INFO,
...
authorizer.add_user("aimc", "qwerty", "/home/pi/SpeGDet/FTP", perm="elradfmw")
authorizer.add_anonymous("/home/pi/SpeGDet/FTP", perm="elradfmw")
