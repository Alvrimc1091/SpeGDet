...
if conexion_lcd():
    ...
    print(f"[{hora_santiago.strftime('%H:%M:%S')}] ----- Pantalla LCD encontrada. Iniciando programa...")
    time.sleep(5)
    ...
    if conexion_sensor:
        ...
        print(f"[{hora_santiago.strftime('%H:%M:%S')}] ----- Sensor encontrado. Iniciando programa...")
        time.sleep(5)
        ...
        if conexion_camara:
            ...
            print(f"[{hora_santiago.strftime('%H:%M:%S')}] ----- Cámara encontrada. Iniciando programa...")
            time.sleep(5)
            ...
            print(f"[{hora_santiago.strftime('%H:%M:%S')}] ----- Cámara no encontrada. Iniciando programa...")
            time.sleep(5)
        ...
        print(f"[{hora_santiago.strftime('%H:%M:%S')}] ----- Sensor no encontrado. Iniciando programa...")
        time.sleep(5)
