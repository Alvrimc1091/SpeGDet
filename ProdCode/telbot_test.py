...
async def run_graindetector_script(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    """
    try:
        result = subprocess.run(["sudo", "python3", "graindetector.py"], capture_output=True, text=True)
...
async def run_graindetector2_script(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    """
    try:
        result = subprocess.run(["sudo", "python3", "rpigrainsensor.py"], capture_output=True, text=True)
...
#             ["sudo", "python3", "graindetector2.py"],
#             capture_output=True,
#             text=True
#         )
