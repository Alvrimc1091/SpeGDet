# Script in
# /home/alvaro/Documents/Workspace/Granos/FTP/save_csv.py

import pandas as pd
import glob

# Define the path pattern to match the .csv files
file_pattern = 'data_proto2_*.csv'
...
for file in file_list:
    ...
    df = pd.read_csv(file, header=None, names=['date', '415nm', '445nm', '480nm', '515nm', '555nm', '590nm', '630nm', '680nm', 'clear', 'nir', 'photo_id'])
...
sorted_df.to_csv('data_test.csv', index=False)
